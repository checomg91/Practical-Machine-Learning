...
## Model built
The expected outcome variable is classe, a variable with 5 levels of factors. 
...
Class A corresponds to the specified execution of the exercise, while the other 4 classes correspond to common mistakes. Decision tree will be used to create the model. After the model has been developed cross-validation will be performed. Two sets of data will be created, original training data set (75%) and subtesting data set (25%). 
